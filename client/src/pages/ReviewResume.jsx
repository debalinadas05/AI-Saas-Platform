  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        {input && (
          <div className="mt-3 flex items-center gap-2 text-xs text-gray-600 bg-gray-50 p-2 rounded-md border border-gray-200">
      ...
      border-gray-200 min-h-96 max-h-[600px]">
        ...
        {!content ? (
          ...
          <div className="mt-3 overflow-y-scroll text-sm text-slate-600 prose prose-sm max-w-none">
